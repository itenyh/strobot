        ...
        return Q.async(function* () {
            ...
            while (true) {
                ...
                if (pay) {
                    ...
                    logger.info('机器人西游记 %s totalWin: %s 剩余金币：%s 到目前为止总利润: %s', this.getId(), totalWin, this.memory.gold, this.memory.profit)
                    const potData = yield this.net.asynQueryXiyoujiJackPot()
